  ...
  render(){
    const frontEndOptions = {
      ...
      series: [
        {
          name:'Technologies',
          data: [["HTML (8 Months)",8],["CSS (6 Months)",6],["JavaScript (4 Months)",4],["Bootstrap (4 Months)",4]],
          size: '45%',
          innerSize: '50%',
          showInLegend:true,
    ...
    const backEndOptions = {
      ...
      series: [
        {
          name:'Technologies',
          data: [["Java (6 Months)",6],["SpringBoot (3 Months)",3],["Python (24 Months)",24],["C# (1 Months)",1]],
          size: '45%',
          innerSize: '50%',
          showInLegend:true,
          dataLabels:{enabled:false}
    ...
    const databaseLayerOptions = {
      ...
      series: [
        {
          name:'Technologies',
          data: [["SQL (10 Months)",10],["MySQL (6 Months)",6],["Hibernate (1 Months)",1]],
          size: '45%',
          innerSize: '50%',
          showInLegend:true,
          dataLabels:{enabled:false}
    ...
    const devToolsOptions = {
      ...
      series: [
        {
          name:'Technologies',
          data: [["IntelliJ (4 Months)",4],["Jupyter Notebook (12 Months)",12],["Visual Studio Code (18 Months)",18],["Jupyter Notebook (7 Months)",7]],
          size: '45%',
          innerSize: '50%',
          showInLegend:true,
          dataLabels:{enabled:false}
    ...
    <div className="App" ref={(el) => (this.componentRef = el)}>
      ...
      <img src={GenSpark} alt="alt" className="gensparkPic"/>
        ...
        <div className="circleContainer">
          ...
          <div className="circleContainer">
            <div className="circle">
              <img src={PurpleCircle} alt="alt" className="circleImage"/>
              <div className="numberEquiv">8</div>
            </div>
      ...
      <div className="equivBody4">
        ...
        <p>
          ...
          If the location is over 10 meters(avaliable to change) far from the leader,the leader's phone will receive the warning message.

        </p>
        <h5 style={{marginBottom:10,fontSize:24,letterSpacing:1,fontWeight:400,marginTop:9}}>
          Roles / Responsibilities
        </h5>
        <p>• Designed and implemented a program to track the location of each members in the goup. 

<br/>• Follow by the project's plan and delivery ontimee for each spring meeting. 
<br/>• Actively discuss and work with the team to improve program performance。
                ...
                <p>
          Android Studio with Java language, BlueTooth, Goolge Map API, Firebase
          </p>
        <hr></hr>
        <h4 style={{fontSize: 24,fontWeight: 400,marginBottom: 5,marginTop:9}}>
        Snake Game
